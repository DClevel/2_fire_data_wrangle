...
knitr::opts_knit$set(root.dir='C:/Users/DClev/OneDrive/Classes/ESS580/0203_FireWrangle/2_fire_data_wrangle')
```
...
As can be seen in the above plot, an increase in NDVI is generally associated with an increase in NDMI.  While this relationship is apparent for both the unburned and burned treatments, it is more clearly seen in the data from the burned treatment.
...
Based on the above plot, there does not appear to be a strong relationship between snowfall over the winter and vegetation growth the following summer, especially for the unburned treatment.  However, there may be some association between an increase in winter snowfall and an increase in vegetation for the burned treatment.
